            ...
            <div class="product-info">
                ...
                <div class="add-to-cart-section">
                    ...
                    <button class="btn-primary add-to-cart" 
                            onclick="handleAddToCart('<?php echo htmlspecialchars($product['id']); ?>')">
                ...
                <a href="product_details.php?pid=<?php echo urlencode($relatedProduct['id']); ?>" class="product-link">
                    <div class="product-card">
                        <div class="product-img">
                            ...
                            <button class="add-btn" onclick="quickAddToCart(event, '<?php echo htmlspecialchars($relatedProduct['id']); ?>')">Add to Cart</button>
                            <div class="icons">
...
function handleAddToCart(productId) {
    ...
    const color = activeColor ? activeColor.style.backgroundColor : '';
